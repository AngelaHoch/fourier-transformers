...
class QControlPanel(QWidget):
	...
	def __init__(self):
		...
		shape_button_circle.setChecked(True)
		...
		variant_button_lowpass.setChecked(True)
		...
		function_button_ideal.setChecked(True)
		...
		function_button_notch = QRadioButton("Notch", function_group)
		...
		function_group_layout.addWidget(function_button_notch)
		...
		function_button_group.addButton(function_button_notch, 3)
